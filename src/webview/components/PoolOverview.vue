...
<style scoped>
.pool{background:var(--sf);border:1px solid var(--bd);border-radius:var(--R);padding:5px 8px;margin-bottom:3px}
...
.pool-pct{font-size:16px;font-weight:800;letter-spacing:-0.5px;line-height:1}
.pool-pct-label{font-size:8px;color:var(--tx3);font-weight:500}
.pool-count{font-size:8px;color:var(--tx3);font-weight:500}
.pool-meters{display:flex;flex-direction:column;gap:1px;margin-bottom:2px}
.meter-head{display:flex;align-items:baseline;justify-content:space-between;margin-bottom:0}
.meter-label{font-size:9px;color:var(--tx);font-weight:600}
.meter-reset{font-size:8px;color:var(--tx3);font-weight:400}
.meter-bar{display:flex;align-items:center;gap:4px}
.meter-track{flex:1;height:4px;border-radius:2px;background:var(--bg);overflow:hidden}
.meter-fill{height:100%;border-radius:2px;transition:width .4s ease}
.meter-val{font-size:9px;font-weight:700;min-width:30px;text-align:right}
.pool-stats{display:flex;gap:2px;flex-wrap:wrap;margin-top:1px}
.chip{display:inline-flex;align-items:center;gap:1px;padding:0 4px;border-radius:7px;font-size:8px;font-weight:500;background:var(--bg2);color:var(--tx2);border:1px solid var(--bd);line-height:1.5}
...
.pool-active{margin-top:3px;padding:3px 6px;background:var(--bg2);border-radius:var(--R3);border:1px solid var(--bd);display:flex;align-items:center;gap:4px}
.pool-active .act-dot{width:4px;height:4px;border-radius:50%;background:var(--gn);flex-shrink:0;box-shadow:0 0 3px var(--gn)}
.pool-active .act-info{flex:1;min-width:0}
.pool-active .act-row{display:flex;align-items:center;gap:2px;flex-wrap:wrap;font-size:9px}
.pool-active .act-name{font-weight:600;color:var(--tx);word-break:break-all;font-size:9px}
.pool-active .act-plan{font-size:7px;font-weight:600;padding:0 2px;border-radius:2px;border:1px solid var(--ac);color:var(--ac)}
.pool-active .act-expiry{font-size:8px}
.pool-active .act-meta{font-size:7px;color:var(--tx3);margin-top:0;display:flex;gap:3px;flex-wrap:wrap}
</style>
