<template>
  <div class="qa-bar">
    ...
    <button class="qa-btn icon" @click="postMessage('refreshAllAndRotate')" title="刷新整个号池">
...
<style scoped>
.qa-bar{display:flex;gap:3px;align-items:center;margin-bottom:4px}
.qa-spacer{flex:1}
.qa-btn{
...
.qa-btn.icon{padding:0 6px;width:26px}
